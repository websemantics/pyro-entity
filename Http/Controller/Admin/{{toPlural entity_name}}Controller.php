...
use {{vendor_name}}\\{{module_name}}Module\\{{entity_name}}\Form\\{{entity_name}}FormBuilder;
use {{vendor_name}}\\{{module_name}}Module\\{{entity_name}}\Table\\{{entity_name}}TableBuilder;
